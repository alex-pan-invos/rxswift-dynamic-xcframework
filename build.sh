...
echo "  git commit -m \"RxSwift $VERSION dynamic xcframeworks\" && git tag $VERSION && git push --tags"
echo "  gh release create $VERSION release/*.xcframework.zip --title \"RxSwift $VERSION (dynamic xcframeworks)\""
